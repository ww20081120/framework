...
import com.hbasesoft.framework.web.system.service.TaskManageService;
 ...
 * @since bps<br>
 * @see com.hbasesoft.framework.web.manager.controller.task <br>
 */
@Controller
@RequestMapping("/system/task")
public class TaskController extends BaseController {

    private static final String PAGE_INDEX = "system/task/index";

    private static final String PAGE_MANAGER = "system/task/taskManager";

    private static final String PAGE_IMPORT = "system/task/importTask";
    ...
    public ModelAndView getTaskManager() throws ServiceException {
        ...
        return new ModelAndView(PAGE_MANAGER, map);
    }
