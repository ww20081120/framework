...
import com.hbasesoft.framework.web.system.dao.dict.DictDao;
 ...
 * @since V7.3<br>
 * @see com.hbasesoft.framework.web.manager.service.dict.impl <br>
 */
@Service
public class DictDetailsServiceImpl implements DictDetailsService {
     ...
     * @CreateDate 2015年10月28日 <br>
     * @since V7.3<br>
     * @see com.hbasesoft.bps.web.service.impl <br>
     */
