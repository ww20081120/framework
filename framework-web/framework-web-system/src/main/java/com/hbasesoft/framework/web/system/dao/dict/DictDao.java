package com.hbasesoft.framework.web.system.dao.dict;
 ...
 * @since V7.3<br>
 * @see com.hbasesoft.framework.web.manager.dao.system.dict <br>
 */
@Dao
public interface DictDao extends IGenericBaseDao {
    ...
    List<DictionaryPojo> queryDict(@Param(Param.PAGE_INDEX) Integer pageIndex, @Param(Param.PAGE_SIZE) Integer pageSize)
        throws DaoException;
    ...
    List<DictionaryDataPojo> queryDictData(@Param("dictCode") String dictCode,
