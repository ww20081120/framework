package com.hbasesoft.framework.web.system.dao;
...
public interface DirectoryDao extends IGenericBaseDao {
    ...
    List<DirectoryPojo> selectList(@Param("parentDirectoryCode") String parentDirectoryCode,
     ...
     */
    @Sql(
        value = "UPDATE DIRECTORY SET DIRECTORY_NAME = :directory.directoryName, REMARK = :directory.remark WHERE DIRECTORY_CODE = :directory.directoryCode")
