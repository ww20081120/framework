package com.hbasesoft.framework.web.system.dao.announcement;
 ...
 * @since bps<br>
 * @see com.hbasesoft.framework.web.manager.dao.system.announcement <br>
 */
@Dao
public interface AnnouncementDao extends IGenericBaseDao {
    ...
    List<AnnouncementPojo> listAnnouncement(@Param(Param.PAGE_INDEX) int pageIndex,
