...
public class DirectoryController extends BaseController {
    ...
    private static final String PAGE_MODIFY = "permission/function/modifyDirectory";
    ...
    public List<DirectoryPojo> list() throws FrameworkException {
    ...
    public ModelAndView toAdd(ModelAndView modelAndView) {
        ...
        modelAndView.setViewName("permission/function/addDirectory");
        return modelAndView;
    }
