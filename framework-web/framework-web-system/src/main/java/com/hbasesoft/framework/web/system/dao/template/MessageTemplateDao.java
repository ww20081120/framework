package com.hbasesoft.framework.web.system.dao.template;
 ...
 * @since bps<br>
 * @see com.hbasesoft.framework.web.manager.dao.system.template <br>
 */
@Dao
public interface MessageTemplateDao extends IGenericBaseDao {
     ...
     */
    @Sql(bean = MessageTemplatePojo.class)
    MessageTemplatePojo queryMessageTemplateById(@Param("messageTemplateId") Integer messageTemplateId)
        throws DaoException;
