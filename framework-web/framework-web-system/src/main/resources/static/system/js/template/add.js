...
class MessageTemplateForm extends Component {
    ...
    render() {
        ...
        return (
            ...
            <Form className="form-horizontal form-label-left" layout="aligned" action={BASEPATH + "/system/messageTemplate/add"}
                  method="post">
                <FormControl labelClassName="col-md-3 col-sm-3 col-xs-12" wrapperClassName="col-md-6 col-sm-6 col-xs-12"
                             name="messageTemplateCode" label="消息编码" placeholder="请输入消息编码"
...
ReactDOM.render(<MessageTemplateForm/>, document.querySelector('.row'));