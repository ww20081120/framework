...
class RoleForm extends Component {
    ...
    render() {
        ...
        return (
            ...
            <Form className="form-horizontal form-label-left" layout="aligned" action={BASEPATH + "/permission/role/add"}
                  method="post">
                <FormControl labelClassName="col-md-3 col-sm-3 col-xs-12" wrapperClassName="col-md-6 col-sm-6 col-xs-12"
                             name="roleName" label="角色名称" placeholder="角色名称"
                             val-require={true} val-require-msg="角色名称不能为空"/>
                <FormControl type="select" name="moduleCode" label="所属模块" data={this.state.module} valueTpl="{moduleCode}"
