...
import com.fccfc.framework.web.manager.service.common.AttrService;
import com.fccfc.framework.web.manager.service.system.DictDetailsService;

@Controller
@RequestMapping("/common/attr")
public class AttrController extends AbstractController {
    ...
    public Map<String, Object> queryAttrValuePager(@PathVariable("attrId") Integer attrId) throws FrameworkException {
        Map<String, Object> result = new HashMap<String, Object>();
        PagerList<AttrValuePojo> dictList = (PagerList<AttrValuePojo>) attrService.queryAttrValuePager(attrId,
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/checkHasChild", method = RequestMethod.GET)
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/checkHasValue", method = RequestMethod.GET)
     ...
     * @throws FrameworkException <br>
     */
    @RequestMapping(value = "/toImportAttr", method = RequestMethod.GET)
    public String toImportAttr(ModelMap modelMap) throws FrameworkException {
        return "attr/importAttr";
    }
     ...
     * @throws FrameworkException <br>
     */
    @RequestMapping(value = "/importAttr", method = RequestMethod.POST)
     ...
     * @throws Exception <br>
     */
    @RequestMapping(value = "/exportAttr", method = RequestMethod.GET)
    ...
    public ModelAndView toAddAttrValue(ModelAndView modelAndView) throws FrameworkException {
        ...
        modelAndView.setViewName("attr/addAttrValue");
        return modelAndView;
    }
     ...
     * @throws FrameworkException <br>
     */
    @RequestMapping(value = "/toImportAttrValue", method = RequestMethod.GET)
    public String toImportAttrValue(ModelMap modelMap) throws FrameworkException {
        return "attr/importAttrValue";
    }
     ...
     * @throws FrameworkException <br>
     */
    @RequestMapping(value = "/toModifyAttrValue")
     ...
     * @throws FrameworkException <br>
     */
    @RequestMapping(value = "/modifyAttrValue", method = RequestMethod.POST)
     ...
     * @throws FrameworkException <br>
     */
    @RequestMapping(value = "/importAttrValue", method = RequestMethod.POST)
     ...
     * @throws Exception <br>
     */
    @RequestMapping(value = "/exportAttrValue", method = RequestMethod.GET)
