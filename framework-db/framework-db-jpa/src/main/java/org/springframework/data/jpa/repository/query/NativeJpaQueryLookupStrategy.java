 ...
 */
public final class NativeJpaQueryLookupStrategy {

    /**
     * Private constructor to prevent instantiation.
     */
    private NativeJpaQueryLookupStrategy() {
    }
    ...
    private abstract static class AbstractQueryLookupStrategy implements QueryLookupStrategy {
         ...
         * org.springframework.data.projection.ProjectionFactory, org.springframework.data.repository.core.NamedQueries)
         */
        @Override
    ...
    private static class DeclaredQueryLookupStrategy extends AbstractQueryLookupStrategy {
         ...
         * (non-Javadoc)
         * @see
         * org.springframework.data.jpa.repository.query.JpaQueryLookupStrategy.AbstractQueryLookupStrategy#resolveQuery
         * (org.springframework.data.jpa.repository.query.JpaQueryMethod, javax.persistence.EntityManager,
         * org.springframework.data.repository.core.NamedQueries)
         */
        @Override
        protected RepositoryQuery resolveQuery(JpaQueryMethod method, EntityManager em, NamedQueries namedQueries) {

            RepositoryQuery query = NativeJpaQueryFactory.INSTANCE.fromQueryAnnotation(method, em,
            ...
            query = NativeJpaQueryFactory.INSTANCE.fromProcedureAnnotation(method, em);
            ...
            if (namedQueries.hasQuery(name)) {
                return NativeJpaQueryFactory.INSTANCE.fromMethodWithQueryString(method, em, namedQueries.getQuery(name),
                    evaluationContextProvider);
            }
