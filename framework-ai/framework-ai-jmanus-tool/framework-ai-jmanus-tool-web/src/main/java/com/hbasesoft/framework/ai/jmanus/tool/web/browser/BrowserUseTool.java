 ...
 */
package com.hbasesoft.framework.ai.jmanus.tool.web.browser;
...
import com.hbasesoft.framework.ai.jmanus.tool.web.browser.actions.BrowserRequestVO;
import com.hbasesoft.framework.ai.jmanus.tool.web.browser.actions.ClickByElementAction;
import com.hbasesoft.framework.ai.jmanus.tool.web.browser.actions.CloseTabAction;
import com.hbasesoft.framework.ai.jmanus.tool.web.browser.actions.ExecuteJsAction;
import com.hbasesoft.framework.ai.jmanus.tool.web.browser.actions.GetElementPositionByNameAction;
import com.hbasesoft.framework.ai.jmanus.tool.web.browser.actions.GetHtmlAction;
import com.hbasesoft.framework.ai.jmanus.tool.web.browser.actions.GetTextAction;
import com.hbasesoft.framework.ai.jmanus.tool.web.browser.actions.InputTextAction;
import com.hbasesoft.framework.ai.jmanus.tool.web.browser.actions.KeyEnterAction;
import com.hbasesoft.framework.ai.jmanus.tool.web.browser.actions.MoveToAndClickAction;
import com.hbasesoft.framework.ai.jmanus.tool.web.browser.actions.NavigateAction;
import com.hbasesoft.framework.ai.jmanus.tool.web.browser.actions.NewTabAction;
import com.hbasesoft.framework.ai.jmanus.tool.web.browser.actions.RefreshAction;
import com.hbasesoft.framework.ai.jmanus.tool.web.browser.actions.ScreenShotAction;
import com.hbasesoft.framework.ai.jmanus.tool.web.browser.actions.ScrollAction;
import com.hbasesoft.framework.ai.jmanus.tool.web.browser.actions.SwitchTabAction;
...
public class BrowserUseTool extends AbstractBaseTool<BrowserRequestVO> {
	...
	private final ISmartContentSavingService innerStorageService;

	private final ObjectMapper objectMapper;

	public BrowserUseTool(ChromeDriverService chromeDriverService, ISmartContentSavingService innerStorageService,
	...
	public ToolExecuteResult run(BrowserRequestVO requestVO) {
		...
		try {
			...
			case "get_html": {
				...
				SmartProcessResult processedResult = innerStorageService.processContent(currentPlanId,
			...
			SmartProcessResult processedResult = innerStorageService.processContent(currentPlanId, result.getOutput(),
					action);
			return new ToolExecuteResult(processedResult.getSummary());
		} catch (Exception e) {
	...
	public Map<String, Object> getCurrentState(Page page) {
		...
		try {
			...
			String interactiveElements = chromeDriverService.getDriver(currentPlanId).getInteractiveElementRegistry()
	...
	// cleanup method already exists, just ensure it conforms to interface
	// specification
	@Override
