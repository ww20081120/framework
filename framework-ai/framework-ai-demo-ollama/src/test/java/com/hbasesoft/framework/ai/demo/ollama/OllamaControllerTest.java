...
class OllamaControllerTest {
    ...
    void testGenerate() throws Exception {
        MvcResult result = mockMvc.perform(get("/ai")
    ...
    void testGenerateCode() throws Exception {
        MvcResult result = mockMvc.perform(get("/ai/code")
                        .param("description", "a simple hello world program in Java"))
                .andExpect(status().isOk())
                .andReturn();
    ...
    void testGenerateStructured() throws Exception {
        MvcResult result = mockMvc.perform(get("/ai/structured")
                        .param("description", "Return a JSON object with name and age fields"))
                .andExpect(status().isOk())
                .andReturn();
