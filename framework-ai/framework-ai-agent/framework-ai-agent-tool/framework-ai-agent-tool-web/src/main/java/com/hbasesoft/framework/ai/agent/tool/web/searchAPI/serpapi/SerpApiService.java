 ...
 */
package com.hbasesoft.framework.ai.agent.tool.web.searchAPI.serpapi;
...
public class SerpApiService {
	...
	public record Request(
			...
			@JsonProperty(required = false, value = "type", defaultValue = "search") @JsonPropertyDescription("search resource type parameter. Currently, only six types are supported. The default parameter is search. ") String type,

			@JsonProperty(required = false, value = "number", defaultValue = "10") @JsonPropertyDescription("The number of search results, default is 10") int number) {
	}
