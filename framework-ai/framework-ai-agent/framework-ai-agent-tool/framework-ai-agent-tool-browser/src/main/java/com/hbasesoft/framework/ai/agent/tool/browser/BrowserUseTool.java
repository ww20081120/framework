...
import com.hbasesoft.framework.ai.agent.tool.browser.actions.BrowserRequestVO;
import com.hbasesoft.framework.ai.agent.tool.browser.actions.ClickByElementAction;
import com.hbasesoft.framework.ai.agent.tool.browser.actions.CloseTabAction;
import com.hbasesoft.framework.ai.agent.tool.browser.actions.ExecuteJsAction;
import com.hbasesoft.framework.ai.agent.tool.browser.actions.GetElementPositionByNameAction;
import com.hbasesoft.framework.ai.agent.tool.browser.actions.GetHtmlAction;
import com.hbasesoft.framework.ai.agent.tool.browser.actions.GetTextAction;
import com.hbasesoft.framework.ai.agent.tool.browser.actions.InputTextAction;
import com.hbasesoft.framework.ai.agent.tool.browser.actions.KeyEnterAction;
import com.hbasesoft.framework.ai.agent.tool.browser.actions.MoveToAndClickAction;
import com.hbasesoft.framework.ai.agent.tool.browser.actions.NavigateAction;
import com.hbasesoft.framework.ai.agent.tool.browser.actions.NewTabAction;
import com.hbasesoft.framework.ai.agent.tool.browser.actions.RefreshAction;
import com.hbasesoft.framework.ai.agent.tool.browser.actions.ScreenShotAction;
import com.hbasesoft.framework.ai.agent.tool.browser.actions.ScrollAction;
import com.hbasesoft.framework.ai.agent.tool.browser.actions.SwitchTabAction;
