...
public class ManusProperties implements IManusProperties {
	...
	@ConfigProperty(group = "manus", subGroup = "browser", key = "headless", path = "manus.browser.headless", description = "manus.browser.headless.description", defaultValue = "false", inputType = ConfigInputType.CHECKBOX, options = {
	...
	@ConfigProperty(group = "manus", subGroup = "browser", key = "requestTimeout", path = "manus.browser.requestTimeout", description = "manus.browser.requestTimeout.description", defaultValue = "180", inputType = ConfigInputType.NUMBER)
	...
	@ConfigProperty(group = "manus", subGroup = "general", key = "debugDetail", path = "manus.general.debugDetail", description = "manus.general.debugDetail.description", defaultValue = "false", inputType = ConfigInputType.CHECKBOX, options = {
			@ConfigOption(value = "true", label = "manus.general.debugDetail.option.true"),
	...
	// Begin---------------------------------------------------------------------------------------
	@ConfigProperty(group = "manus", subGroup = "interaction", key = "openBrowser", path = "manus.openBrowserAuto", description = "manus.interaction.openBrowser.description", defaultValue = "true", inputType = ConfigInputType.CHECKBOX, options = {
			@ConfigOption(value = "true", label = "manus.interaction.openBrowser.option.true"),
	...
	@ConfigProperty(group = "manus", subGroup = "agent", key = "maxSteps", path = "manus.maxSteps", description = "manus.agent.maxSteps.description", defaultValue = "20", inputType = ConfigInputType.NUMBER)
	...
	@ConfigProperty(group = "manus", subGroup = "agents", key = "forceOverrideFromYaml", path = "manus.agents.forceOverrideFromYaml", description = "manus.agent.forceOverrideFromYaml.description", defaultValue = "true", inputType = ConfigInputType.CHECKBOX, options = {
			@ConfigOption(value = "true", label = "manus.agent.forceOverrideFromYaml.option.true"),
	...
	@ConfigProperty(group = "manus", subGroup = "agent", key = "userInputTimeout", path = "manus.agent.userInputTimeout", description = "manus.agent.userInputTimeout.description", defaultValue = "300", inputType = ConfigInputType.NUMBER)
	...
	@ConfigProperty(group = "manus", subGroup = "agent", key = "maxMemory", path = "manus.agent.maxMemory", description = "manus.agent.maxMemory.description", defaultValue = "1000", inputType = ConfigInputType.NUMBER)
	...
	@ConfigProperty(group = "manus", subGroup = "agent", key = "parallelToolCalls", path = "manus.agent.parallelToolCalls", description = "manus.agent.parallelToolCalls.description", defaultValue = "false", inputType = ConfigInputType.CHECKBOX, options = {
			@ConfigOption(value = "true", label = "manus.agent.parallelToolCalls.option.true"),
...
//		}
	...
	@ConfigProperty(group = "manus", subGroup = "infiniteContext", key = "enabled", path = "manus.infiniteContext.enabled", description = "manus.infiniteContext.enabled.description", defaultValue = "true", inputType = ConfigInputType.CHECKBOX, options = {
			@ConfigOption(value = "true", label = "manus.infiniteContext.enabled.option.true"),
	...
	@ConfigProperty(group = "manus", subGroup = "infiniteContext", key = "parallelThreads", path = "manus.infiniteContext.parallelThreads", description = "manus.infiniteContext.parallelThreads.description", defaultValue = "6", inputType = ConfigInputType.NUMBER)
	...
	@ConfigProperty(group = "manus", subGroup = "infiniteContext", key = "taskContextSize", path = "manus.infiniteContext.taskContextSize", description = "manus.infiniteContext.taskContextSize.description", defaultValue = "20000", inputType = ConfigInputType.NUMBER)
	...
	@ConfigProperty(group = "manus", subGroup = "filesystem", key = "allowExternalAccess", path = "manus.filesystem.allowExternalAccess", description = "Whether to allow file operations outside the working directory", defaultValue = "false", inputType = ConfigInputType.CHECKBOX, options = {
			@ConfigOption(value = "true", label = "Yes"), @ConfigOption(value = "false", label = "No") })
	...
	@ConfigProperty(group = "manus", subGroup = "mcpServiceLoader", key = "connectionTimeoutSeconds", path = "manus.mcpServiceLoader.connectionTimeoutSeconds", description = "manus.mcpServiceLoader.connectionTimeoutSeconds.description", defaultValue = "20", inputType = ConfigInputType.NUMBER)
	...
	@ConfigProperty(group = "manus", subGroup = "mcpServiceLoader", key = "maxRetryCount", path = "manus.mcpServiceLoader.maxRetryCount", description = "manus.mcpServiceLoader.maxRetryCount.description", defaultValue = "3", inputType = ConfigInputType.NUMBER)
	...
	@ConfigProperty(group = "manus", subGroup = "mcpServiceLoader", key = "maxConcurrentConnections", path = "manus.mcpServiceLoader.maxConcurrentConnections", description = "manus.mcpServiceLoader.maxConcurrentConnections.description", defaultValue = "10", inputType = ConfigInputType.NUMBER)
