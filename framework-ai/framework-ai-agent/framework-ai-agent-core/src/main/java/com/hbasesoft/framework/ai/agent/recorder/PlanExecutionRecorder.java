...
public interface PlanExecutionRecorder {
	...
	/**
	 * Parameter encapsulation class for recording all relevant information about
	 * plan execution
	 */
	@Data
	public class PlanExecutionParams {
		...
		public void setActToolInfoList(List<ThinkActRecord.ActToolInfo> actToolInfoList) {
