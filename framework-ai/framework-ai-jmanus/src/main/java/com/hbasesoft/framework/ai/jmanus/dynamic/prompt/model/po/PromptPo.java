 ...
 ****************************************************************************************/
package com.hbasesoft.framework.ai.jmanus.dynamic.prompt.model.po;
 ...
 * @since V1.0<br>
 * @see com.hbasesoft.framework.ai.jmanus.dynamic.prompt.model.po <br>
 */
@Getter
@Setter
@Entity
@Table(name = "prompt", uniqueConstraints = { @UniqueConstraint(columnNames = { "namespace", "prompt_name" }) })
public class PromptPo extends BaseEntity {
