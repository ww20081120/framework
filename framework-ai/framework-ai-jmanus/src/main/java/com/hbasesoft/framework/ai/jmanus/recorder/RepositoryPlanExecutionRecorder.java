 ...
 * @since V1.0<br>
 * @see com.hbasesoft.framework.ai.jmanus.recorder <br>
 */
...
public class RepositoryPlanExecutionRecorder implements PlanExecutionRecorder {
	...
	/**
	 * Save execution records of the specified plan ID to persistent storage. This
	 * method will recursively call save methods of PlanExecutionRecord,
	...
	/**
	 * Get the plan execution record to update in memory. Returns the record that
	 * should be updated with current execution data.
	 */
	 ...
	 * execution record management logic without exposing internal record objects.
	 */
	@Override
	 ...
	 * handles ThinkActRecord creation and thinking process without exposing
	 ...
	 * ThinkActRecord with action results without exposing internal record objects.
	 */
	@Override
	 ...
	 * recording logic without exposing internal record objects.
	 */
	@Override
	 ...
	 * @return Root plan execution record, or null if not found and
	 ...
	 * @param createIfNotExists Whether to create if not exists
	 * @return Sub-plan execution record, or null if thinkActRecordId is null or not
	 *         found and createIfNotExists is false
	 */
