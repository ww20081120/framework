 ...
 ****************************************************************************************/
package com.hbasesoft.framework.ai.jmanus.dynamic.mcp.model.po;
 ...
 * @since V1.0<br>
 * @see com.hbasesoft.framework.ai.jmanus.dynamic.mcp.model.po <br>
 */
@Getter
@Setter
@Entity
@Table(name = "mcp_config")
public class McpConfigPo extends BaseEntity {
