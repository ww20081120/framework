 ...
 ****************************************************************************************/
package com.hbasesoft.framework.ai.jmanus.dynamic.model.model.po;
...
public class DynamicModelPo extends BaseEntity {
	...
	public DynamicModelPo() {
	}

	public DynamicModelPo(Long id) {
		this.id = id;
	}
	...
	public ModelConfig mapToModelConfig() {
		...
		config.setIsDefault(this.isDefault());
