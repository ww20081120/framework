 ...
 ****************************************************************************************/
package com.hbasesoft.framework.ai.jmanus.dynamic.agent.dao;
 ...
 * @since V1.0<br>
 * @see com.hbasesoft.framework.ai.jmanus.dynamic.agent.dao <br>
 */
@Dao
public interface DynamicAgentDao extends BaseDao<DynamicAgentPo> {
