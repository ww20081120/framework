 ...
 */
package com.hbasesoft.framework.ai.jmanus.tool.textOperator;
...
public class TextFileOperator extends AbstractBaseTool<TextFileOperator.TextFileInput> {
	...
	/**
	 * Internal input class for defining input parameters of text file operation
	 * tool
	 */
	...
	public TextFileOperator(TextFileService textFileService, ISmartContentSavingService innerStorageService,
	...
	private ToolExecuteResult getAllText(String planId, String filePath) {
		try {
			...
			SmartProcessResult processedResult = innerStorageService.processContent(planId,
