...
public class QwenLanguageModel implements LanguageModel {
     ...
     * @param seed
     */
    protected QwenLanguageModel(final String apiKey, final String modelName, final Double topP, final Integer topK,
    ...
    public Response<String> generate(final String prompt) {
        try {
            ...
            return Response.from(QwenHelper.answerFrom(generationResult), QwenHelper.tokenUsageFrom(generationResult),
