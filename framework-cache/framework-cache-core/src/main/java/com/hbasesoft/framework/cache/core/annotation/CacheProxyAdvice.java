 ...
 */
@Component
public class CacheProxyAdvice implements BeanPostProcessor {
    ...
    public Object postProcessBeforeInitialization(Object bean, String beanName) throws BeansException {
        ...
        for (Method method : methods) {
            ...
            if (name.length() > 3 && name.startsWith("set")
                ...
                try {
                    ...
                    LoggerUtil.error("Failed to init remote service reference at method " + name + " in class " + bean.getClass().getName() + ", cause: " + e.getMessage(), e);
                }
            }
        }
        ...
        for (Field field : fields) {
            try {
                ...
                LoggerUtil.error("Failed to init remote service reference at filed " + field.getName() + " in class " + bean.getClass().getName() + ", cause: " + e.getMessage(), e);
            }
        }
        return bean;
    }
    ...
    private <T> T refer(CacheProxy cacheProxy, Class<T> clazz) {
        ...
        if (Modifier.isAbstract(clazz.getModifiers())) {
            ...
            T proxyObj =  (T) Proxy.newProxyInstance(clazz.getClassLoader(),
