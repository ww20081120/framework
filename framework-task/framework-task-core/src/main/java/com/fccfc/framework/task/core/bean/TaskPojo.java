...
public class TaskPojo extends BaseEntity {
     ...
     * serialVersionUID <br>
     */
    private static final long serialVersionUID = 5410571188868023151L;
    ...
    public TaskPojo(Task task) {
        ...
        this.isConcurrent = task.getIsConcurrent();
        this.taskState = task.getTaskState();
        this.lastExecuteTime = CommonUtil.getDate(task.getLastExecuteTime());
        this.nextExcuteDate = CommonUtil.getDate(task.getNextExcuteDate());
        this.operatorId = task.getOperatorId();
        this.createTime = CommonUtil.getDate(task.getCreateTime());
    }
