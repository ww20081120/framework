...
public class XxlJobConfig {
    ...
    public XxlJobSpringExecutor xxlJobExecutor() {
        ...
        xxlJobSpringExecutor.setAdminAddresses(
            PropertyHolder.getProperty("job.xxl.admin.addresses", "http://127.0.0.1:8080/xxl-job-admin"));

        // 执行器通讯TOKEN [选填]：非空时启用；
        String accessToken = PropertyHolder.getProperty("job.xxl.accessToken");
        ...
        xxlJobSpringExecutor
            .setAppname(PropertyHolder.getProperty("job.xxl.executor.appname", "xxl-job-executor-sample"));
        String ip = PropertyHolder.getProperty("job.xxl.executor.ip");
