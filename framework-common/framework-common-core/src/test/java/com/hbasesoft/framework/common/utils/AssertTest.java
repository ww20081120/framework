...
public class AssertTest {
    ...
    public void notNull() {
        ...
        Assert.notNull(obj, ErrorCodeDef.FAILURE);
    ...
    public void isNull() {
        Object obj = null;
        Assert.isNull(obj, ErrorCodeDef.FAILURE);
    ...
    public void notEmpty() {
        ...
        Assert.notEmpty(str, ErrorCodeDef.FAILURE);
        System.out.println("str 不是空字符串");

        List<String> strList = new ArrayList<>();
        strList.add(str);
        Assert.notEmpty(strList, ErrorCodeDef.FAILURE);
        System.out.println("strList 不是空集合");

        String[] strs = new String[] {
            str
        };
        Assert.notEmpty(strs, ErrorCodeDef.FAILURE);
        System.out.println("strs 不是空数组");

        Map<String, String> strMap = new HashMap<>();
        strMap.put("a", str);
        Assert.notEmpty(strMap, ErrorCodeDef.FAILURE);
    ...
    public void isEmpty() {
        String str = null;
        Assert.isEmpty(str, ErrorCodeDef.FAILURE);
        ...
        Assert.isEmpty(strList, ErrorCodeDef.FAILURE);
        ...
        String[] strs = null;
        Assert.isEmpty(strs, ErrorCodeDef.FAILURE);
        ...
        Assert.isEmpty(strMap, ErrorCodeDef.FAILURE);
    ...
    public void notEquals() {
        String a = "abc";
        String b = "abd";
        Assert.notEquals(a, b, ErrorCodeDef.FAILURE);
        System.out.println("字符串a not equals 字符串b");

        Object c = new Object();
        Object d = new Object();
        Assert.notEquals(c, d, ErrorCodeDef.FAILURE);
    ...
    public void isTrue() {
        ...
        Assert.isTrue(a.equals(b), ErrorCodeDef.FAILURE);
        System.out.println("字符串a equals 字符串b");

        Assert.isTrue(a != b, ErrorCodeDef.FAILURE);
