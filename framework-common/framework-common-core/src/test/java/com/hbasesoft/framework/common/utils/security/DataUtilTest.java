...
public class DataUtilTest {
    ...
    public void md5For16() {
        ...
        Assert.assertEqual(str2, "49BA59ABBE56E057", ErrorCodeDef.FAILURE);
    }
    ...
    public void md5() {
        ...
        Assert.assertEqual(str2, "E10ADC3949BA59ABBE56E057F20F883E", ErrorCodeDef.FAILURE);
    }
    ...
    public void base64Decode() {
        ...
        Assert.assertEqual(str2, "123456", ErrorCodeDef.FAILURE);
    }
    ...
    public void base64Encode() {
        ...
        Assert.assertEqual(str2, "MTIzNDU2", ErrorCodeDef.FAILURE);
    }
    ...
    public void encryptPassowrd() {
        ...
        Assert.isTrue(DataUtil.matchPassword(str1, str2), ErrorCodeDef.FAILURE);
    }
    ...
    public void encrypt() {
        ...
        Assert.assertEqual(str1, str3, ErrorCodeDef.FAILURE);
    }
    ...
    public void byte2HexStr() {
        ...
        Assert.assertEqual(str2, "61626364656667", ErrorCodeDef.FAILURE);
    }
    ...
    public void hexStr2Byte() {
        ...
        Assert.assertEqual(str2, "abcdefg", ErrorCodeDef.FAILURE);
    }
}
