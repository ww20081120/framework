...
public final class DateUtil {
    ...
    public static int daysBetween(final Date startDate) {
        return betweenDay(startDate, getCurrentDate());
    }
    ...
    public static Date parse(final String ds) {
        ...
        switch (dateStr.length()) {
            case DATE_LENGTH_8:
                date = parse(dateStr, DateConstants.DATE_FORMAT_8);
                break;
            case DATE_LENGTH_10:
                date = parse(dateStr,
                ...
                break;
            case DATE_LENGTH_11:
                date = parse(dateStr, DateConstants.DATE_FORMAT_11);
                break;
            case DATE_LENGTH_14:
                date = parse(dateStr, DateConstants.DATETIME_FORMAT_14);
                break;
            case DATE_LENGTH_17:
                date = parse(dateStr, DateConstants.DATETIME_FORMAT_17);
                break;
            case DATE_LENGTH_19:
                date = parse(dateStr,
                ...
                break;
            case DATE_LENGTH_21:
                date = parse(dateStr, DateConstants.DATETIME_FORMAT_21);
                break;
            case DATE_LENGTH_23:
                date = parse(dateStr,
