...
public class SerializationUtilTest {
    ...
    public void serial() {
        ...
        Assert.equals(hexStr, "02FF0187007759BC931200000000000B68656C6C6F20776F726C64", ErrorCodeDef.SYSTEM_ERROR);
    }
    ...
    public void unserial() {
        ...
        Assert.equals(bean.getName(), "hello world", ErrorCodeDef.SYSTEM_ERROR);
    }
    ...
    public void unserial3() {
        ...
        System.out.println(bean);
        Assert.equals(bean.get(0).getName(), "hello world", ErrorCodeDef.SYSTEM_ERROR);
    }
