 ...
 */
public class StartupListener02Test implements StartupListener {
    ...
    @Override
    public void init() {
        System.out.println("执行StartupListenerTest02的init方法");
    }
    ...
    @Override
    public void destory() {
        System.out.println("执行StartupListenerTest02的destory方法");
    }
}
