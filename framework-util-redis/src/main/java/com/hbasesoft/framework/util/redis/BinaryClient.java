...
import static com.hbasesoft.framework.util.redis.Protocol.Command.*;
import static com.hbasesoft.framework.util.redis.Protocol.Keyword.ENCODING;
import static com.hbasesoft.framework.util.redis.Protocol.Keyword.IDLETIME;
import static com.hbasesoft.framework.util.redis.Protocol.Keyword.LEN;
import static com.hbasesoft.framework.util.redis.Protocol.Keyword.LIMIT;
import static com.hbasesoft.framework.util.redis.Protocol.Keyword.NO;
import static com.hbasesoft.framework.util.redis.Protocol.Keyword.ONE;
import static com.hbasesoft.framework.util.redis.Protocol.Keyword.REFCOUNT;
import static com.hbasesoft.framework.util.redis.Protocol.Keyword.RESET;
import static com.hbasesoft.framework.util.redis.Protocol.Keyword.STORE;
import static com.hbasesoft.framework.util.redis.Protocol.Keyword.WITHSCORES;
...
import com.hbasesoft.framework.util.redis.Protocol.Command;
import com.hbasesoft.framework.util.redis.Protocol.Keyword;
...
public class BinaryClient extends Connection {
    ...
    public void zrevrangeByScore(final byte[] key, final String max, final String min, final int offset, int count) {
        ...
        sendCommand(ZREVRANGEBYSCORE, key, max.getBytes(), min.getBytes(), LIMIT.raw, toByteArray(offset),
            toByteArray(count));
    }
    ...
    public void zrangeByScoreWithScores(final byte[] key, final double min, final double max, final int offset,
        final int count) {
    ...
    public void zrangeByScoreWithScores(final byte[] key, final String min, final String max, final int offset,
        final int count) {
        sendCommand(ZRANGEBYSCORE, key, min.getBytes(), max.getBytes(), LIMIT.raw, toByteArray(offset),
            toByteArray(count), WITHSCORES.raw);
    }

    public void zrevrangeByScoreWithScores(final byte[] key, final double max, final double min, final int offset,
        final int count) {
    ...
    public void zrevrangeByScoreWithScores(final byte[] key, final String max, final String min, final int offset,
        final int count) {
